    ...
    <div class="main_full">
        <div class="layui-col-md12">
            ...
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('region_user/'.$region_user->id)}}" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="phone" value="{{ $region_user->phone }}" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans("admin_user.label.phone") }}" class="layui-input" disabled>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">{{ trans("region_user.label.new_password") }}</label>
                        <div class="layui-input-inline">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="radio" name="roles[]" value="{{ $role->id }}" title="{{ $role->name }}" {{ !($region_user->hasRole($role->slug)) ? :'checked'}}>
                            @endforeach
                        </div>
                    </div>
