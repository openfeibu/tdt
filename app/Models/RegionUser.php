...
use App\Traits\RegionRoles\HasRoleAndPermission;
use App\Contracts\AdminUserPolicy;
use App\Traits\AdminUser\AdminUser as AdminUserProfile;

class RegionUser extends AuthModel implements AdminUserPolicy
{
     ...
     * @var array
     */
    protected $config = 'model.user.region_user.model';
