        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('system_page/create')); ?>">添加系统文章</a></button>
...
<script>
    var main_url = "<?php echo e(guard_url('system_page')); ?>";
    var delete_all_url = "<?php echo e(guard_url('system_page/destroyAll')); ?>";
    layui.use(['jquery','element','table'], function(){
        ...
        form.on('switch(lock)', function(obj){
            $.post("<?php echo e(guard_url('business/updateRecommend')); ?>",{"id":this.value,"home_recommend":obj.elem.checked,'_token':"<?php echo csrf_token(); ?>" },function(){
