...
<div class="layui-input-inline">
    <div class="layui-upload-drag" id="uploadImage_<?php echo $field; ?>">
        ...
        <p>点击上传，或将文件拖拽到此处</p>
        <?php if($files): ?>
            <img id="image_<?php echo $field; ?>" src="<?php echo url("/image/sm".$files['path']); ?>" style="position:absolute;height:120px;width:100%;left:0px;top: 0px;">
        <?php else: ?>
            <img id="image_<?php echo $field; ?>" src="" style="position:absolute;height:120px;width:100%;left:0px;top: 0px;display: none;">
        <?php endif; ?>
